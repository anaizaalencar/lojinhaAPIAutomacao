...
public class ProdutoTest {
    ...
    public void beforeEach(){
        ...
        this.token = given()
                ...
                .body(UsuarioDataFactory.UsuarioAdmin("admin", "admin"))
        .when()
                .post("/v2/login")
        .then()
                .extract()
    ...
    public void testValidarLimiteZeradoProibidoValorProduto(){
        //Tentar inserir um produto com valor 0.00 e validar que a mensagem de erro foi apresentado e o status code retornado foi 422
        given()
                .contentType(ContentType.JSON)
    ...
    public void testValidarLimiteMaiorSeteMilProibidoValorProduto() {
        //Tentar inserir um produto com valor maior que 7000.01 e validar que a mensagem de erro foi apresentado e o status code retornado foi 422
        given()
                .contentType(ContentType.JSON)
                .header("token", this.token)
